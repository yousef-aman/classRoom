...
// ///////////////////////////////////////////////
let submit =()=>{
    Inertia.post('/quiz/add/', form )
}

let deleteQ=(id)=>{
    Inertia.delete(`/subject/delete/${id}`)
}
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                    <div class="card-header flex-column flex-md-row">
                        <div class="head-label text-center">
                            <h5 class="card-title mb-0">Subject's</h5>
                        </div>
                        <div class="dt-action-buttons text-end pt-3 pt-md-0">
                            <div class="dt-buttons">
                                ...
                                <button @click="addsubject" class="dt-button create-new btn btn-primary" tabindex="0" aria-controls="DataTables_Table_0" type="button">
                                        <span><i class="bx bx-plus me-sm-2">

                                        </i> <span class="d-none d-sm-inline-block" >Add New Subject</span>
                                        </span>
                                </button>
                            </div>
                        </div>
                    ...
                    <table class="datatables-basic table table-bordered dataTable no-footer dtr-column" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info" style="width: 1266px;">
                        ...
                        <tr role="row">
                            ...
                            <th class="sorting" >subject's</th>
                            <th class="sorting" style="width:20%">Quizzes</th>


                            <th class="sorting_disabled" style="width: 25%">Actions</th></tr>
                        </thead>
                        <tbody>
                        <td valign="top" v-if="!Subjects.length " colspan="7" class="dataTables_empty">No data available in table</td>
                            ...
                            <tr class="odd">
                                ...
                                <td>
                                    <div class="card-body">
                                        ...
                                        <div class="demo-inline-spacing">
                                            <div class="btn-group">
                                                <Link :href="`/quiz/show/${subject.id}`">
                                                    <button type="button" class="btn rounded-pill btn-warning">Show Quizzes</button>
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <td>
                                    <div class="card-body">
                                        ...
                                        <div class="demo-inline-spacing">
                                            <div class="btn-group">
                                                <button  data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddUser" type="button" class="btn rounded-pill btn-success " @click="subjectID = subject.id" >
                                                    Add Quizzes
                                                </button>

                                            </div>
                                            <div class="btn-group">
                                                <button @click="deleteQ(subject.id)" type="button" class="btn rounded-pill btn-danger">
                                                    Delete
                                                </button>
        ...
        >
            <div class="offcanvas-header border-bottom">
                <h6 id="offcanvasAddUserLabel" class="offcanvas-title">Add Quizzes</h6>
                <button
                    type="button"
                ...
                <form class="add-new-user pt-0" id="addNewUserForm" >
                    ...
                    <template v-for="(item,index) in form.name" :key="index" >
                        <div class="mb-3">
                            ...
                            <label class="form-label" for="add-user-fullname">Quiz {{ index+1 }}</label>
